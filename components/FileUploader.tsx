    ...
    return (
        <FormItem className="w-full">
            ...
            <FormControl>
                <div
                    className={cn(
                        'upload-dropzone border-2 border-dashed border-blue-200 bg-blue-50/30 hover:bg-blue-50 transition-all rounded-lg cursor-pointer flex flex-col items-center justify-center p-6',
